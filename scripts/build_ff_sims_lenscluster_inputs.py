...
def _write_par(
    ...
    cosmology_lambda = 1.0 - float(config.cosmology_omega_m)
...
cosmologie
    H0 {_format_float(config.cosmology_h0)}
    omega {_format_float(config.cosmology_omega_m)}
    lambda {_format_float(cosmology_lambda)}
    end
champ
    dmax {dmax}
    end
